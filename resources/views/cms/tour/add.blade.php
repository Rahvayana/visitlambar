...
<div class="content-header sty-one">
    <h1 class="text-black">Add New Tour Package</h1>
    <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
...
<div class="content">
    <div class="info-box">
        <form id="tour-form" action="{{ route('cms.tour.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <h4 class="text-black m-b-3">New Tour Package Detail</h4>
            <div id="demo">
                <div class="step-app">
                    <ul class="step-steps">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        <textarea class="form-control" name="desc" id="descTextarea" rows="3" required></textarea>
                                    </fieldset>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row m-t-2" id="plan">
                                <div class="col-md-12 m-b-2 px-5">
                                    <fieldset class="form-group">
                                        ...
                                        <textarea class="form-control" name="plan_desc" id="descTextarea" rows="3" required></textarea>
                                    </fieldset>
                                </div>
                                <div class="col-md-12 m-b-2 px-5">
                                    <div class="row">
