                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home" role="tabpanel" aria-expanded="true">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="user-img pull-left"> <img src="{{ asset('cms/img/img3.jpg')}}" class="img-circle img-responsive" alt="User Image"> </div>
                                    </div>
                                    <div class="col-lg-10">
                                        <div class="mail-contnet">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-xs-4 m-bot-2"><img src="{{ asset('cms/img/img7.jpg')}}" alt="user" class="img-responsive img-rounded"></div>
                                                <div class="col-lg-3 col-xs-4 m-bot-2"><img src="{{ asset('cms/img/img8.jpg')}}" alt="user" class="img-responsive img-rounded"></div>
                                                <div class="col-lg-3 col-xs-4 m-bot-2"><img src="{{ asset('cms/img/img9.jpg')}}" alt="user" class="img-responsive img-rounded"></div>
                                                <div class="col-lg-3 col-xs-4 m-bot-2"><img src="{{ asset('cms/img/img10.jpg')}}" alt="user" class="img-responsive img-rounded"></div>
                                            </div>
                                ...
                                <div class="row m-t-3">
                                    <div class="col-lg-2">
                                        <div class="user-img pull-left"> <img src="{{ asset('cms/img/img5.jpg')}}" class="img-circle img-responsive" alt="User Image"> </div>
                                    </div>
                                    <div class="col-lg-10">
                                        <div class="mail-contnet">
                                            <h5>Florence Douglas</h5>
            ...
            <div>
                ...
                <div class="box box-widget widget-user-2">
                    ...
                    <ul class="products-list product-list-in-box">
                        <li class="item">
                            <div class="product-img"> <img src="{{ asset('cms/img/img1.jpg')}}" alt="Product Image"> </div>
